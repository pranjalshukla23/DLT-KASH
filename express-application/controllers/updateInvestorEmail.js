...
module.exports.updateInvestorEmail = async(req,res) => {

    try {
        const {uccRequestId, emailIdStatus} = req.body;
       ...
       // trails.push(currentInvestorRequest);
        const investorRequestBuffer = await regnetContract.submitTransaction('updateInvestorRequestEmail',uccRequestId, emailIdStatus);
