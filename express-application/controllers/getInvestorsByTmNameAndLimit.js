...
module.exports.getInvestorsByTmNameAndLimit = async(req,res) => {
    ...
    try {
        ...
        const investorsRequestBuffer = await regnetContract.submitTransaction('getInvestorsByTmName', TmName);
