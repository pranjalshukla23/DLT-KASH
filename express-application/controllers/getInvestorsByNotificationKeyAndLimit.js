...
module.exports.getInvestorsByNotificationKeyAndLimit = async(req,res) => {
    ...
    try {
        ...
        const investorsRequestBuffer = await regnetContract.submitTransaction('getInvestorsByNotificationKey', notificationKey);
